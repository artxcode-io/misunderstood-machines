...
const hl = (function () {
  ...
  const mintSize = searchParams.get("ms") || Math.floor(Number(editionSize) * Math.random() + 1).toString();
  const mintIteration = searchParams.get("mi") || Math.floor((Number(mintSize) - 1) * Math.random() + 1).toString();
  ...
  const tokenId = searchParams.get("tid") || Math.floor(Number(editionSize) * Math.random()).toString();
  ...
  const gasPrice = searchParams.get("gp") || Math.floor(Math.random() * (200 - 10 + 1) + 10).toString();
  const gasUsed = searchParams.get("gu") || Math.floor(Math.random() * (100 - 10 + 1) + 10).toString();
